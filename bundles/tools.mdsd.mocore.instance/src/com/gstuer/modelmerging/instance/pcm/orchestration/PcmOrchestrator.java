...
import com.gstuer.modelmerging.instance.pcm.merger.relation.ComponentDeploymentRelationMerger;
...
public class PcmOrchestrator extends Orchestrator<PcmSurrogate> {
    public PcmOrchestrator(PcmSurrogate model) {
        super(model, new ComponentMerger(model), new DeploymentMerger(model),
                new ComponentComponentRelationMerger(model), new ComponentDeploymentRelationMerger(model));
    }
